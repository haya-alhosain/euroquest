...
export default function BlogCard({ blog, className = "" }: BlogCardProps) {
  ...
  return (
    <div className={`swiper-slide flex-shrink-0 ${className}`}>
      <Link
        className="w-[280px] md:w-[280px] sm:w-[260px] xs:w-[calc(100vw-80px)] h-auto bg-white overflow-hidden transition-all duration-300 ease-in-out p-3 shadow-[4px_4px_40px_0_rgba(62,94,192,0.1)] rounded-xl cursor-pointer mx-3 md:mx-3 sm:mx-3 xs:mx-2 hover:shadow-[4px_4px_20px_0_rgba(62,94,192,0.27)] block"
