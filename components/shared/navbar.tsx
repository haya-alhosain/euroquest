              ...
              >
                <nav className="flex-1 py-6">
                  {navLinks.map((link, index) => (
                    <motion.div
                      key={link.href}
                      className="mb-2 px-6 max-[480px]:px-4"
                    ...
                    >
                      ...
                      >
                        <Link
                          href={link.href}
                          className={`flex items-center px-5 py-4 rounded-2xl no-underline font-medium text-base transition-all duration-300 relative ${
                            isActive(link.href)
                              ? "font-bold "
                              : ""
                          }`}
                  ...
                  {/* Contact Button */}
                  <motion.div
                    className="mt-4 px-6 max-[480px]:px-4"
                    initial={{ x: 30, opacity: 0 }}
                    animate={{ x: 0, opacity: 1 }}
                    transition={{
                ...
                {/* Sidebar Footer */}
                <motion.div
                  className="p-6 bg-gradient-to-br from-slate-50 to-slate-200 border-t border-blue-200/20 max-[480px]:p-4"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
