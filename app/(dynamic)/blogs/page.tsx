...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    // Fallback metadata
    return {
      title: "Training & Development Blogs | EuroQuest International Expert Articles",
      ...
      keywords: "training blogs, development articles, leadership insights, management tips, HR resources, project planning, career growth, professional development, industry trends",
    };
  }
}
